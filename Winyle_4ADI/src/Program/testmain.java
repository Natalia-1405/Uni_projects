...
{	
    ...
    public static void main(String[] args) 
    {
    	...
    	String wybor=""; 
    	char zn;
    	String type, nam="", edt="", dist="", sur="", ttl="", oldnam="", oldsur="", pass;
         ...
         do
        {
            ...
            case "g":
				...
				c("4 - Search for RPM");
				c("5 - Search for a title based on the first letter.");
				c("l - leave");
				wybor=scanner.nextLine();
				switch(wybor)
				{
					...
					case "5":
						c("Letter: ");
						zn=scanner.nextLine().charAt(0);
						i=collection.searchTitleAlphabet(zn);
						if(i==0)
							c("Nothing was found. Click ENTER to proceed");
						else
							c("Found. Click ENTER to proceed.");
